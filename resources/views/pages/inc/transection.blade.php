<section class="transactions py-6">
    <div class="container">
        ...
        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="rounded-3xl border border-brand-border bg-brand-surface p-6">
                <div class="flex items-center justify-between">
                    ...
                    <i class="fa-solid fa-receipt text-4xl text-brand-primary"></i>
                </div>
            </div>
            ...
            <div class="rounded-3xl border border-brand-border bg-brand-surface p-6">
                <div class="flex items-center justify-between">
                    ...
                    <i class="fa-solid fa-arrow-down text-4xl text-green-500"></i>
                </div>
            </div>
        ...
        {{-- Filters --}}
        <div class="mt-6 rounded-3xl border border-brand-border bg-brand-surface p-6">
            ...
            <div class="overflow-x-auto">
                ...
                <table class="w-full min-w-[1100px]">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-brand-border">
                            <td class="py-5">TX982145</td>
                            <td class="py-5">Deposit</td>
                            <td class="py-5 text-green-500">+Rs.5,000</td>
                            <td class="py-5">EasyPaisa</td>
                        ...
                        <tr class="border-b border-brand-border">
                            <td class="py-5">TX982102</td>
                            <td class="py-5">Withdraw</td>
                            <td class="py-5 text-red-500">-Rs.2,500</td>
                            <td class="py-5">JazzCash</td>
                        ...
                        <tr class="border-b border-brand-border">
                            <td class="py-5">TX981888</td>
                            <td class="py-5">Bonus</td>
                            <td class="py-5 text-brand-primary">+Rs.500</td>
                            <td class="py-5">Joining Bonus</td>
                        ...
                        <tr>
                            <td class="py-5">TX981500</td>
                            <td class="py-5">Entry Fee</td>
                            <td class="py-5 text-red-500">-Rs.1</td>
