                ...
                <div class="rounded-3xl border border-brand-border bg-brand-surface">
                    ...
                    <form>
                        ...
                        <div class="mt-10">
                            ...
                            <div class="grid lg:grid-cols-3 gap-6 mt-6">
                                ...
                                <label
                                    ...
                                    <i class="fa-solid fa-id-card text-5xl text-brand-primary"></i>
                                    <h5 class="mt-5">
                                        Front Side
                                    </h5>
                                ...
                                <label
                                    class="cursor-pointer rounded-2xl border-2 border-dashed border-brand-border p-8 text-center hover:border-brand-primary">
                                    <i class="fa-solid fa-address-card text-5xl text-brand-primary"></i>
                                    <h5 class="mt-5">
                                        Back Side
                                    </h5>
                                    <p class="mt-2 text-sm opacity-70">
                                ...
                                <label
                                    class="cursor-pointer rounded-2xl border-2 border-dashed border-brand-border p-8 text-center hover:border-brand-primary">
                                    <i class="fa-solid fa-camera text-5xl text-brand-primary"></i>
                                    <h5 class="mt-5">
                                        Selfie
                                    </h5>
                                    <p class="mt-2 text-sm opacity-70">
                        ...
                        <div class="mt-10 space-y-4">
                            <label class="flex items-cneter gap-2 cursor-pointer">
                                <input type="checkbox">
                                <span>
