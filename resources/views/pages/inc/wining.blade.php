        ...
        <div class="mt-6 rounded-3xl border border-brand-border bg-brand-surface p-8">
            <div class="grid items-center gap-8 lg:grid-cols-2">
                ...
                <div class="text-center">
                    <img src="{{ asset('images/draw/prize.png') }}" alt="Prize" class="mx-auto max-w-sm">
                </div>
            </div>
        </div>
        {{-- Prize Progress --}}
                ...
                <table class="w-full min-w-[950px]">
                    ...
                    <thead>
                        <tr class="border-b border-brand-border">
                            ...
                            <th class="py-4 text-left">Winning Date</th>
                            <th class="py-4 text-left">Prize Value</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-brand-border">
                            <td class="py-5">Honda CG125</td>
                            <td class="py-5">One Rupee Game</td>
                            <td class="py-5">12 Jul 2026</td>
                            <td class="py-5 text-green-500">Rs.250,000</td>
                            <td class="py-5">
                            ...
                            <td class="py-5">
                                <button class="btn-primary px-5 py-2 text-sm">
                                    View
                                </button>
                            </td>
                        </tr>
                        ...
                        <tr class="border-b border-brand-border">
                            ...
                            <td class="py-5 text-green-500">Rs.65,000</td>
                            <td class="py-5">
                        ...
                        <tr>
                            <td class="py-5">Rs.500 Cash</td>
                            <td class="py-5">Daily Spin</td>
                            <td class="py-5">28 Jun 2026</td>
                            <td class="py-5 text-green-500">Rs.500</td>
                            <td class="py-5">
