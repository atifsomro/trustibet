            ...
            <table class="w-full min-w-[900px] text-[12px] md:text-base lg:text-xl">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-brand-border">
                        ...
                        <td class="py-3 sm:py-5">iPhone 16 Pro</td>
                        <td class="py-3 sm:py-5">TB102541</td>
                        <td class="py-3 sm:py-5">Rs.1</td>
                        <td class="py-3 sm:py-5">15 Jul 2026</td>
                    ...
                    <tr class="border-b border-brand-border">
                        <td class="py-3 sm:py-5">One Rupee Game</td>
                        <td class="py-3 sm:py-5">Honda Bike</td>
                        <td class="py-3 sm:py-5">TB102210</td>
                        <td class="py-3 sm:py-5">Rs.1</td>
                    ...
                    <tr>
                        ...
                        <td class="py-3 sm:py-5">TB101985</td>
                        <td class="py-3 sm:py-5">Rs.1</td>
