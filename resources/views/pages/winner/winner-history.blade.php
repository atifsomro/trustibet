        ...
        <div class="container">
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="rounded-3xl border border-brand-border bg-brand-surface p-6">
                    ...
                    <h2 class="text-brand-primary">Rs.12,50,000</h2>
                </div>

                <div class="rounded-3xl border border-brand-border bg-brand-surface p-6">
                    <p class="opacity-70">Latest Winner</p>
                    <h2 class="text-green-500">Today</h2>
                </div>
                    ...
                    <table class="w-full">
                        ...
                        <thead class="border-b border-brand-border">
                            ...
                            <tr>
                                ...
                                <th class="p-5 text-left">Winner</th>

                                <th class="p-5 text-left">Prize</th>

                                <th class="p-5 text-left">Winning Number</th>

                                <th class="p-5 text-left">Draw ID</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-brand-border hover:bg-brand-dark duration-300">
                                ...
                                <td class="p-5 text-brand-primary font-semibold">
                                    Rs.50,000
                                </td>
