                        ...
                        <form class="mt-8">
                            ...
                            <div class="rounded-2xl bg-brand-dark p-6 mt-8">
                                ...
                                <div class="bg-white p-2 w-50 h-50 flex items-center content-center m-auto">
                                    <img id="paymentQR" src="{{ asset('images/account/qr.png') }}"
                            ...
                            <div class="mt-8">
                                ...
                                <input type="file" id="paymentProof" accept=".jpg,.jpeg,.png,.webp"
                    ...
                    <table class="w-full min-w-[850px]">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="py-5">
                                    <span class="px-4 py-1 rounded-full bg-green-500/20 text-green-500">
                                        Approved
                                    </span>
                                </td>
                            </tr>
