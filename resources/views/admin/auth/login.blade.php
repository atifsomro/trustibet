...
<head>
    ...
    <title>Trustbet - Admin Panel</title>

    <!-- page css -->
    <link href="{{ asset('assets/admin_assets/dist/css/pages/login-register-lock.css') }}" rel="stylesheet">
    <!-- Custom CSS -->
...
<body class="skin-default card-no-border">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Trustbet Admin</p>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <section id="wrapper">
        <div class="login-register"
            style="background-image:url({{ asset('assets/admin_assets/images/background/login-register.jpg') }}">
