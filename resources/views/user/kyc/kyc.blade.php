    ...
    <div class="grid xl:grid-cols-12 gap-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="full_name" placeholder="Enter your full name"
                                class="w-full rounded-xl border border-brand-border bg-brand-dark px-4 py-3 outline-none focus:border-brand-primary" required>
                        </div>
                        <div>
                            <label class="mb-2 block">
                                Date of Birth
                        ...
                        <div>
                            ...
                            <input type="text" name="country" value="Pakistan"
                                class="w-full rounded-xl border border-brand-border bg-brand-dark px-4 py-3 opacity-70" required>
                        </div>
                        <div>
                            <label class="mb-2 block">
                                ID Type
                    ...
                    <div class="mt-4 sm:mt-10">
                        ...
                        <div class="grid lg:grid-cols-3 gap-6 mt-6">
                            ...
                            <label
                                ...
                                <input type="file" name="selfie_image" class="hidden" required>
                            </label>
                        </div>
                    </div>
                    {{-- Address --}}
        ...
        <div class="xl:col-span-4">
            ...
            <div class="rounded-3xl border border-brand-border bg-brand-surface p-8">
                <div class="sm:flex flex-col sm:text-start text-center sm:items-start items-center gap-3">
                    <i class="fa-solid fa-shield-halved text-xl sm:text-3xl text-yellow-500"></i>
                    <div>
                        <h4>KYC Status</h4>
